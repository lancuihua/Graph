...
def main():
    ...
    parser.add_argument('--model', type=str, default='gat_neighsampler')
    ...
    train_loader = NeighborSampler(data.adj_t, node_idx=train_idx, sizes=[10, 5], batch_size=256, shuffle=True,
                                   num_workers=1)
    layer_loader = NeighborSampler(data.adj_t, node_idx=None, sizes=[-1], batch_size=1024, shuffle=False,
                                   num_workers=1)
